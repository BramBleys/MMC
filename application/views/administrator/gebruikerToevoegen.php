...
<div class="form-row">
    <div class="col-12 col-md-6">
        ...
        echo "<p>" .
            ...
            "<br>" .
            form_input('voornaam','','id="voornaam" class="form-control" required') .
    ...
    <div class="col-12">
        <div class="d-flex flex-nowrap justify-content-end">
            ...
            echo anchor('administrator/gebruikersBeheren/1','Annuleren','class="btn btn-outline-primary mr-2 order-1"');
