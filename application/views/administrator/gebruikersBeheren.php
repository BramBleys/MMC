...
/**
 * @file administrator/gebruikersBeheren.php
 *
...
<script>
    ...
    {
        $.ajax({type : "GET",
            url : site_url + "/administrator/haalAjaxOp_Gebruikers",
    ...
    $(document).ready(function () {
        ...
        switch (soortId) {
            ...
            case 3:
                ...
                break;
            case 4:
                $(".gebruikerOphalen[data-id=4]").removeClass().addClass("btn btn-primary gebruikerOphalen");
                break;
        }
...
<div class="row mb-4">
    <div class="col-3">
        ...
        echo anchor('', 'MMC Medewerkers', array('class' => 'btn btn-light gebruikerOphalen', 'data-id' => '4')) . "\n";
        ?>
        <div class="mt-4">
...
<div class="row">
    <div class="col-12">
        ...
        echo anchor('/administrator/gebruikerToevoegen', 'Gebruiker toevoegen', array('class' => 'btn btn-primary mb-4')) . "\n";
